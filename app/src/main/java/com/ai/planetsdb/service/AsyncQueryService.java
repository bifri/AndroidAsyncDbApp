 ...
 * 0847dbf80788392f1e6e2a25f6f0a91e1f9cda04/src/com/android/calendar/
...
import com.ai.planetsdb.service.AsyncQueryServiceHelper.OperationInfo;
...
/**
 * A helper class that executes {@link android.content.ContentResolver} calls in a background
 ...
 * which calls the {@link android.content.ContentResolver} in a background thread. This supports
 * query/insert/update/delete and also batch mode i.e.
 * {@link android.content.ContentProviderOperation}. It also supports delay execution and cancel
...
public class AsyncQueryService extends Handler {
    ...
    /**
     * This method begins an asynchronous {@link android.content.ContentProviderOperation}. When
     ...
     * @param cpo the {@link android.content.ContentProviderOperation} to be executed.
     * @param delayMillis delay in executing the operation. This operation will
     *            execute before the delayed time when another operation is
     *            added. Useful for implementing single level undo.
     */
    ...
    /**
     * Called when an asynchronous {@link android.content.ContentProviderOperation} is
     * completed.
     *
     * @param token the token to identify the query, passed in from
     *            {@link #startDelete}.
